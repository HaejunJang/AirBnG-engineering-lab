...
import com.airbng.platform.security.filter.CustomAuthenticationFilter;
import com.airbng.platform.security.filter.CustomLogoutFilter;
import com.airbng.platform.security.filter.JwtFilter;
import com.airbng.platform.security.handler.*;
        ...
        http
                ...
                .authorizeHttpRequests((auth) -> auth
                        ...
                        .requestMatchers(
                                ...
                                "/lockers/popular", "/error", "/alarms/**", "/ws-chat/**", "/actuator/**"
                        )
                        .permitAll()
